...
const TextFieldTextArea = <T extends ValidComponent = "textarea">(
  ...
  return (
    <TextFieldPrimitive.TextArea
      class={cn(
        "flex min-h-[120px] w-full rounded-none border-2 border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 shadow-[4px_4px_0_0_rgba(0,0,0,0.08)]",
        local.class
      )}
      {...others}
    />
